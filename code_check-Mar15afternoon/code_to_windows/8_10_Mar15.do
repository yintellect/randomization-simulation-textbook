...
/*---- dist1 ----*/
preserve	
simulate  coef_Z=r(coef_Z), reps(10000): coeff_Z Y	
...
preserve	
simulate  fstat=r(fstat), reps(10000): F_stat Y day
...
/*---- dist3 ----*/
preserve	
simulate  coef_Z=r(coef_Z), reps(10000): coeff_Z Ylag
...
preserve	
simulate  coef_Z=r(coef_Z), reps(10000): coeff_Z energy 
...
preserve	
simulate  coef_Z=r(coef_Z), reps(10000): coeff_Z gre 
