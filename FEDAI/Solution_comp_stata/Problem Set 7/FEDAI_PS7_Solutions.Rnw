...
opts_chunk$set(fig.path='figure/PS7-', fig.align='center', fig.show='hold', out.width = '4in', out.height='4in', tidy=FALSE)
...
<<Q6setup, echo=FALSE, cache=FALSE>>=
rm(list=ls())
library(foreign)
angrist <- read.dta("~/Dropbox/Teaching 2017-2018/Experiments/Data and R Programs/Chapter 7/Angrist_et_al_AER_2006.dta")
@
