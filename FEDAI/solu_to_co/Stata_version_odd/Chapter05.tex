...
\begin{figure}[H]
    ...
    \subfloat[Treatment Group]{{\includegraphics[width=7cm]{../data/Stata_version/figure/exercise_6_1b_treatment.pdf}}}
    \qquad
    \subfloat[Control Group]{{\includegraphics[width=7cm]{../data/Stata_version/figure/exercise_6_1b_control.pdf} }}
\end{figure}
