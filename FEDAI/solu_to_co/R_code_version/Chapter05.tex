...
\begin{figure}[H]
    ...
    \subfloat[Treatment Group]{{\includegraphics[width=7cm]{../data/R_code_version/figure/PS51btreatment.pdf} }}
    \qquad
    \subfloat[Control Group]{{\includegraphics[width=7cm]{../data/R_code_version/figure/PS51bcontrol.pdf} }}
\end{figure}
