...
\begin{alltt}
\hlcom{# get rid of a couple of observations with missing outcome data}
\hlstd{beijing} \hlkwb{<-} \hlkwd{na.omit}\hlstd{(beijing.all)}
\hlstd{Z} \hlkwb{<-}     \hlstd{beijing}\hlopt{$}\hlstd{treat2}
\hlstd{Y} \hlkwb{<-}     \hlstd{beijing}\hlopt{$}\hlstd{turnout}
\hlstd{D} \hlkwb{<-}     \hlstd{beijing}\hlopt{$}\hlstd{contact}
\hlstd{clust} \hlkwb{<-} \hlstd{beijing}\hlopt{$}\hlstd{dormid}

\hlstd{ITT} \hlkwb{<-} \hlkwd{mean}\hlstd{(Y[Z} \hlopt{==} \hlnum{1}\hlstd{])} \hlopt{-} \hlkwd{mean}\hlstd{(Y[Z} \hlopt{==} \hlnum{0}\hlstd{])}
\hlstd{ITT}
\end{alltt}
\begin{verbatim}
## [1] 0.1319296
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{probs} \hlkwb{<-} \hlkwd{genprobexact}\hlstd{(Z,}\hlkwc{clustvar}\hlstd{=clust)}  \hlcom{# subjects are clustered by dorm room}
...
\hlstd{perms} \hlkwb{<-} \hlkwd{genperms}\hlstd{(Z,}\hlkwc{maxiter}\hlstd{=numiter,}\hlkwc{clustvar}\hlstd{=clust)}    \hlcom{# clustered assignment}
\end{alltt}
\begin{verbatim}
