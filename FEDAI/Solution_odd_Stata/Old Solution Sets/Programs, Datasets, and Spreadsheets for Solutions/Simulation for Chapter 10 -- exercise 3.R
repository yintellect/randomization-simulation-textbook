# simulation to illustrate special conditions under which regression recovers direct and indirect effects
...
#### Now consider what would happen if potential outcomes were a bit different
