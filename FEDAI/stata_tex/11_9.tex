...
\makeatother
    ...
    \hypertarget{problem-11.9}{%
\section{Problem 11.9}\label{problem-11.9}}
...
{\color{incolor}In [{\color{incolor}2}]:} \PY{k}{gen} purchased =.
        ...
        \PY{k}{		qui}\PY{k}{ glm} purchased log\PYZus{}price\PYZus{}star\PYZus{}\PY{n+nv}{`}\PY{n+nv}{i}\PY{n+nv}{\PYZsq{}} i\PY{l+m}{.}region, family(binomial) link(logit)
        \PY{k}{		}
