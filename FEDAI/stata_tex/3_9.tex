...
\section{Problem 3.9}\label{problem-3.9}}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{k}{qui} import delim .\PY{o}{/}data\PY{o}{/}chapter03\PY{o}{/}Camerer\PYZus{}JPEsubset\PYZus{}1998,\PY{k}{ clear}
...
\subsection{Part b}\label{part-b}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{k}{rename} treatment D
        \PY{k}{rename} pair block
        \PY{k}{rename} preexperimentbets covs
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{c+c1}{//}\PY{c+c1}{ }\PY{c+c1}{c}\PY{c+c1}{a}\PY{c+c1}{l}\PY{c+c1}{c}\PY{c+c1}{u}\PY{c+c1}{l}\PY{c+c1}{a}\PY{c+c1}{t}\PY{c+c1}{e}\PY{c+c1}{ }\PY{c+c1}{p}\PY{c+c1}{r}\PY{c+c1}{o}\PY{c+c1}{b}\PY{c+c1}{s}\PY{c+c1}{ }\PY{c+c1}{u}\PY{c+c1}{n}\PY{c+c1}{d}\PY{c+c1}{e}\PY{c+c1}{r}\PY{c+c1}{ }\PY{c+c1}{b}\PY{c+c1}{l}\PY{c+c1}{o}\PY{c+c1}{c}\PY{c+c1}{k}\PY{c+c1}{ }\PY{c+c1}{a}\PY{c+c1}{s}\PY{c+c1}{s}\PY{c+c1}{i}\PY{c+c1}{g}\PY{c+c1}{n}\PY{c+c1}{m}\PY{c+c1}{e}\PY{c+c1}{n}\PY{c+c1}{t}
...
\subsection{Part c}\label{part-c}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{k}{rename} experimentbets change
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{k}{tabstat} change,\PY{k}{ by}(D) stat(mean)\PY{k}{ save}	
...
\subsection{Part d}\label{part-d}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{k}{qui}\PY{k}{ bysort} block (D):\PY{k}{ gen} pair\PYZus{}diff = change \PY{o}{\PYZhy{}} change[\PYZus{}n\PY{l+m}{+1}]
...
\subsection{Part e}\label{part-e}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:} \PY{k}{cap}\PY{k}{ program}\PY{k}{ drop} ate\PYZus{}block	
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} ritest D \PY{n+nf}{r}(ate), strata(block) reps(\PY{l+m}{10000}) nodots: \PY{c+cs}{///}
