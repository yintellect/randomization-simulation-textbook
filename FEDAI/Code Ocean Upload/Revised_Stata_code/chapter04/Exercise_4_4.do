log using ../results/chapter04/exercise_4_4, replace
...
graph export ../results/chapter04/exercise_4_4_d_graph.pdf
...
graph export ../results/chapter04/exercise_4_4_f_graph.pdf
...
ritest D Ys_cov = r(Ys_cov), reps(10000) sav(ate_null_cov.dta, replace) nodots: ate_null_cov
...
graph export ../results/chapter04/exercise_4_4_g_graph.pdf

restore

log close
translate ../results/chapter04/exercise_4_4.smcl ../results/chapter04/exercise_4_4.pdf, translator(smcl2pdf)
