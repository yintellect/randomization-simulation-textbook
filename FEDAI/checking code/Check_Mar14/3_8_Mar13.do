...
use "Titiunik_WorkingPaper_2010.dta",clear 
...
----------------------------------------------*/
	...
	di "ate_texas= "ate_texas
	di "ate_arkansas= "ate_ark
...
----------------------------------------------*/
	...
	di "se_texas= " se_texas
	di "se_arkansas= " se_arkansas
...
----------------------------------------------*/
	...
	//
	ritest D r(ate), strata(block) reps(1000): ///
	ate_block Y D probs
