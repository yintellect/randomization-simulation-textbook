...
import delim GerberGreenBook_Chapter4_Exercises_4-5
set seed 1234567
...
ritest D Ys = r(Ys), reps(10000) sav(ate_null.dta, replace): ate_null
...
ritest D Ys_cov = r(Ys_cov), reps(10000) sav(ate_null_cov.dta, replace): ate_null_cov
