log using ../results/chapter09/exercise_9_3, replace
...
// (uncomment to search the package and then install)	
// search vlookup, all
...
log close
translate ../results/chapter09/exercise_9_3.smcl ../results/chapter09/exercise_9_3.pdf, translator(smcl2pdf)
